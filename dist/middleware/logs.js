...
exports.enableLoggedResponses = enableLoggedResponses;
const logger = __importStar(require("express-logger-functions"));
function initRequestLogger(req, _res, next) {
    logger.info(req, 'Initializing router. Body type:', typeof req.body);
    logger.debug(req, 'Body:', req.body);
    next();
}
function enableLoggedResponses(req, res, next) {
